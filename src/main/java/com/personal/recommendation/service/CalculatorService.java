...
public interface CalculatorService {
     ...
     * @return Object
     */
    Object executeInstantJob(List<Long> userIDList, int type);
     ...
     */
    HashMap<Long, ArrayList<Long>> getBrowsedHistoryMap();
     ...
     * @return HashSet<Long>
     */
    List<Long> getBrowsedNewsSet();

    /**
     * 将所有当天被浏览过的新闻提取出来，以便进行TF-IDF求值操作，以及对用户喜好关键词列表的更新。
     * @return HashMap<String, Object>
     */
    HashMap<String, Object> getNewsTFIDFMap();
