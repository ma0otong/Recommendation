...
public class TestUtility {
    ...
    private static void ensureFullData() {
     ...
     * @return name的绝对路径
     */
    private static String ensureData(String name, String url) {
     ...
     * @return name的绝对路径
     */
    private static String ensureData(String name, String url, String parentPath, boolean overwrite) {
     ...
     * @return String
     */
    public static String ensureTestData(String fileUrl, String url) {
        return ensureData(fileUrl, url);
    }
     ...
     */
    private static String downloadFile(String fileURL, String savePath)
            throws IOException {
